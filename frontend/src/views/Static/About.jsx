      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="rounded-2xl border border-border bg-card p-6 sm:p-8 shadow-xs">
          ...
          <p className="mt-4 text-sm sm:text-base text-muted-foreground leading-relaxed">
            Welcome to <strong className="text-foreground">{siteName}</strong> — Your Premier Destination for Kids & Baby Essentials!
          </p>
          <p className="mt-3 text-sm sm:text-base text-muted-foreground leading-relaxed">
            At <strong className="text-foreground">{siteName}</strong>, we specialize exclusively in high-quality items for children and babies. Our mission is to make parenting easier and childhood more fun by bringing together top-tier toys, kids clothing, footwear, baby care products, and interactive learning gadgets.
          </p>
          <p className="mt-3 text-sm sm:text-base text-muted-foreground leading-relaxed">
            From Electronic & RC Toys, STEM Educational Toys, Soft Toys, Kids Clothing & Shoes to Baby Care, Nursery Essentials, and Outdoor Play Equipment, every product in our shop is safe, durable, and crafted for kids of all ages.
          </p>
          <p className="mt-3 text-sm sm:text-base text-muted-foreground leading-relaxed">
