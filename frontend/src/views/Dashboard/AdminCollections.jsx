...
export default function AdminCollections() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      {/* Top Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-gradient-to-r from-purple-500/10 via-pink-500/10 to-rose-500/10 dark:from-purple-950/30 dark:to-pink-950/30 p-6 rounded-2xl border border-purple-100 dark:border-purple-900/40 backdrop-blur-md">
        <div>
          <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white flex items-center gap-2">
            <Layers className="w-7 h-7 text-purple-600" /> Dynamic Collection Manager
          </h1>
          <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">
            Create promotional seasonal collections (Toys Special, Baby Essentials, Best Sellers, Learning Games) independent of category hierarchy
          </p>
        </div>
        <Button onClick={openCreateModal} className="bg-purple-600 hover:bg-purple-700 text-white rounded-xl shadow-lg shadow-purple-500/20 gap-2">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16 bg-white dark:bg-slate-900 rounded-2xl border border-dashed border-slate-200 dark:border-slate-800">
          ...
          <p className="text-slate-500 text-sm mt-1 mb-4">Add collections like Toys Special, Baby Care, or New Arrival to group products dynamically.</p>
          <Button onClick={openCreateModal} className="bg-purple-600 hover:bg-purple-700 text-white rounded-xl">
            ...
            >
              {col.banner || col.image ? (
                ...
                <div className="p-5 pb-0">
                  ...
                  <code className="text-xs text-purple-600 dark:text-purple-400 font-mono">{col.slug}</code>
                </div>
              )}
              ...
              <div className="p-5 space-y-3">
                ...
                <div className="flex items-center justify-between text-xs pt-2 border-t border-slate-100 dark:border-slate-800">
                  <span className="bg-purple-50 dark:bg-purple-950/50 text-purple-700 dark:text-purple-300 px-2.5 py-1 rounded-full font-semibold">
                    {col.productCount || 0} Products
                  </span>
                  <div className="flex items-center gap-1">
                    <button onClick={() => openEditModal(col)} className="p-1.5 text-slate-500 hover:text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-950/50 rounded-lg">
              ...
              <form onSubmit={handleSubmit} className="p-5 space-y-4 max-h-[80vh] overflow-y-auto">
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <Input
                      placeholder="e.g. Toy Special, Baby Essentials"
                      value={name}
                      onChange={(e) => {
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-3 text-sm text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-purple-500"
                  />
                </div>
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-slate-100 dark:border-slate-800">
                  ...
                  <Button type="submit" disabled={createMutation.isPending || updateMutation.isPending} className="bg-purple-600 hover:bg-purple-700 text-white rounded-xl">
