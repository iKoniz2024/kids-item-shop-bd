...
const sendInvoiceEmail = async (order, targetEmail = null) => {
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:620px;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                        <tr>
                            <td style="background:linear-gradient(135deg,#0B3C73 0%,#082d56 100%);padding:32px 36px;">
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <h1 style="margin:0;font-size:26px;font-weight:700;color:#ffffff;letter-spacing:0.5px;">Kids Item Shop</h1>
                        ...
                        <tr>
                            <td style="background:#082d56;border-top:1px solid #0B3C73;padding:20px 36px;text-align:center;">
                                <p style="margin:0 0 4px;font-size:12px;color:#ffffff;">Thank you for shopping with <strong style="color:#FFA800;">Kids Item Shop</strong></p>
    ...
    return await sendMail({
        to: email,
        subject: `Invoice - Order #${orderShortId} | Kids Item Shop`,
        html,
    });
};
